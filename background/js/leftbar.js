	...
	function factorlist() {
	    result = $.ajax({url:"factor_list.php",async:false});
		$("#tab").html(result.responseText);
	}
	function memberlist() {
	    result = $.ajax({url:"member_list.php",async:false});
		$(".rightbox").html(result.responseText);
	}
	function groupnoticelist() {
	    result = $.ajax({url:"group_notice_list.php",async:false});
		$("#tab").html(result.responseText);
	}
	function lablist() {
	    result = $.ajax({url:"lab_list.php",async:false});
		$("#tab").html(result.responseText);
	}
	function paperlist() {
    ...
    function downloadlist(){
        result = $.ajax({url:"download_list.php",async:false});
        $("#tab").html(result.responseText);
    }
	function slidelist(){
